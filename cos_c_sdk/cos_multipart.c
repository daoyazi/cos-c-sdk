                                   ...
                                   aos_table_t **resp_headers)
{
    ...
    apr_table_add(query_params, COS_UPLOAD_ID, upload_id->data);
    aos_table_add_int(query_params, COS_MAX_PARTS, params->max_ret);
    apr_table_add(query_params, COS_PART_NUMBER_MARKER, 
                                        ...
                                        aos_table_t **resp_headers)
{
    ...
    apr_table_add(query_params, COS_KEY_MARKER, params->key_marker.data);
    apr_table_add(query_params, COS_UPLOAD_ID_MARKER, params->upload_id_marker.data);
    aos_table_add_int(query_params, COS_MAX_UPLOADS, params->max_ret);
                                          ...
                                          aos_table_t **resp_headers)
{
    ...
    apr_table_add(query_params, COS_UPLOAD_ID, upload_id->data);
    aos_table_add_int(query_params, COS_PARTNUMBER, part_num);
                                   ...
                                   aos_table_t **resp_headers)
{
    ...
    aos_table_add_int(query_params, COS_PARTNUMBER, params->part_num);
...
aos_status_t *cos_get_sorted_uploaded_part(cos_request_options_t *options,
                                           const aos_string_t *bucket, 
                                           const aos_string_t *object, 
                                           const aos_string_t *upload_id, 
                                           ...
                                           int *part_count)
{
    ...
    part_arr = aos_palloc(parent_pool, COS_MAX_PART_NUM * sizeof(cos_upload_part_t *));
