 ...
 * cos_json.c
 */
void test_get_json_doc_with_empty_aos_list(CuTest *tc)
{
    int ret;
    cJSON *json_node;
    aos_list_t bc;
    ...
    ret = get_jsondoc(&bc, &json_node);
    CuAssertIntEquals(tc, AOSE_json_PARSE_ERROR, ret);

    printf("test_get_json_doc_with_empty_aos_list ok\n");
}
...
CuSuite *test_aos()
{
    ...
    SUITE_ADD_TEST(suite, test_get_json_doc_with_empty_aos_list);
